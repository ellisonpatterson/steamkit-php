...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgOpenNewTabResponse
 */
class CMsgOpenNewTabResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgOpenNewTabResponse) {
