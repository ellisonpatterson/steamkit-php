...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgFocusedNodeTextResponse
 */
class CMsgFocusedNodeTextResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgFocusedNodeTextResponse) {
