...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgNeedsPaintResponse
 */
class CMsgNeedsPaintResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgNeedsPaintResponse) {
