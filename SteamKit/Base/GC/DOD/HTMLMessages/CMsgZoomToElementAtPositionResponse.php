...
/**
 * Protobuf message :
 * SteamKit.Base.GC.DOD.HTMLMessages.CMsgZoomToElementAtPositionResponse
 */
class CMsgZoomToElementAtPositionResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgZoomToElementAtPositionResponse) {
