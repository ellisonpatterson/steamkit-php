...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgSavePageToJPEGResponse
 */
class CMsgSavePageToJPEGResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgSavePageToJPEGResponse) {
