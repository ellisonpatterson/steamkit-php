...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgVerticalScrollBarSize
 */
class CMsgVerticalScrollBarSize extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgVerticalScrollBarSize) {
