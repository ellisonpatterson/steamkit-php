...
/**
 * Protobuf message :
 * SteamKit.Base.GC.DOD.HTMLMessages.CMsgCloseFullScreenFlashIfOpen
 */
class CMsgCloseFullScreenFlashIfOpen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgCloseFullScreenFlashIfOpen) {
