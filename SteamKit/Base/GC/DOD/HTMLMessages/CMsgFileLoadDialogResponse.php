...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgFileLoadDialogResponse
 */
class CMsgFileLoadDialogResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ($this->files === null) {
            $this->files = new \Protobuf\ScalarCollection();
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->files->add($reader->readString($stream));
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgFileLoadDialogResponse) {
