...
/**
 * Protobuf message :
 * SteamKit.Base.GC.DOD.HTMLMessages.CMsgHorizontalScrollBarSizeResponse
 */
class CMsgHorizontalScrollBarSizeResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgHorizontalScrollBarSizeResponse) {
