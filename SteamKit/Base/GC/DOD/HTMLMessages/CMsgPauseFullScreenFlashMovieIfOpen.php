...
/**
 * Protobuf message :
 * SteamKit.Base.GC.DOD.HTMLMessages.CMsgPauseFullScreenFlashMovieIfOpen
 */
class CMsgPauseFullScreenFlashMovieIfOpen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgPauseFullScreenFlashMovieIfOpen) {
