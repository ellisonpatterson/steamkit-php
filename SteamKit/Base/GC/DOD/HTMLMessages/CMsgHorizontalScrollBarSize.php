...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgHorizontalScrollBarSize
 */
class CMsgHorizontalScrollBarSize extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgHorizontalScrollBarSize) {
