...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgSetHorizontalScroll
 */
class CMsgSetHorizontalScroll extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgSetHorizontalScroll) {
