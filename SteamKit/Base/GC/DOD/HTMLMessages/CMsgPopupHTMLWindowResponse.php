...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgPopupHTMLWindowResponse
 */
class CMsgPopupHTMLWindowResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgPopupHTMLWindowResponse) {
