...
/**
 * Protobuf message : SteamKit.Base.GC.DOD.HTMLMessages.CMsgBrowserErrorStrings
 */
class CMsgBrowserErrorStrings extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\DOD\HTMLMessages\CMsgBrowserErrorStrings) {
