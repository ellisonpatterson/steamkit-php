...
namespace SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCHUpdateSession;

/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgGCHUpdateSession.ExtraField
 */
class ExtraField extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCHUpdateSession\ExtraField) {
