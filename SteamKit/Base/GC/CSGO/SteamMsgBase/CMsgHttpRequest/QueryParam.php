...
namespace SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgHttpRequest;

/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgHttpRequest.QueryParam
 */
class QueryParam extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgHttpRequest\QueryParam) {
