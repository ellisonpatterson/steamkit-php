...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgAMGetUserGameStats
 */
class CMsgAMGetUserGameStats extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgAMGetUserGameStats) {
