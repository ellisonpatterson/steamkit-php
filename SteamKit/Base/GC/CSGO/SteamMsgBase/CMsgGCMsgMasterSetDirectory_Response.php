...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgGCMsgMasterSetDirectory_Response
 */
class CMsgGCMsgMasterSetDirectory_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCMsgMasterSetDirectory_Response) {
