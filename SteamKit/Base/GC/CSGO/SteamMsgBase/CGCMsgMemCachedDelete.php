...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgBase.CGCMsgMemCachedDelete
 */
class CGCMsgMemCachedDelete extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CGCMsgMemCachedDelete) {
