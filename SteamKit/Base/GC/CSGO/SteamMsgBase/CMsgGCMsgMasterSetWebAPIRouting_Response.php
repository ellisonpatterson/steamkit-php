...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgGCMsgMasterSetWebAPIRouting_Response
 */
class CMsgGCMsgMasterSetWebAPIRouting_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCMsgMasterSetWebAPIRouting_Response) {
