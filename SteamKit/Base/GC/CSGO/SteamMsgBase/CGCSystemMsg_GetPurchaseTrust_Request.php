...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CGCSystemMsg_GetPurchaseTrust_Request
 */
class CGCSystemMsg_GetPurchaseTrust_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CGCSystemMsg_GetPurchaseTrust_Request) {
