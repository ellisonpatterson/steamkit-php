...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgGCGetPersonaNames
 */
class CMsgGCGetPersonaNames extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCGetPersonaNames) {
