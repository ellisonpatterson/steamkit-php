...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CGCSystemMsg_GetAccountDetails
 */
class CGCSystemMsg_GetAccountDetails extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        ...
        $options->extensions()->add(\SteamKit\Base\GC\CSGO\SteamMsgBase\Extension::msgpoolSoftLimit(), 128);
        $options->extensions()->add(\SteamKit\Base\GC\CSGO\SteamMsgBase\Extension::msgpoolHardLimit(), 512);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CGCSystemMsg_GetAccountDetails) {
