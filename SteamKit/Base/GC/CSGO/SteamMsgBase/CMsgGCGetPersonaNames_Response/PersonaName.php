...
namespace SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCGetPersonaNames_Response;
...
class PersonaName extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgGCGetPersonaNames_Response\PersonaName) {
