...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgBase.CGCSystemMsg_GetAccountDetails_Response
 */
class CGCSystemMsg_GetAccountDetails_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CGCSystemMsg_GetAccountDetails_Response) {
