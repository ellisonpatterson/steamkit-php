...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgBase.CMsgAMSendEmailResponse
 */
class CMsgAMSendEmailResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgBase\CMsgAMSendEmailResponse) {
