...
namespace SteamKit\Base\GC\CSGO\SteamMsgGCSDK\CMsgClientWelcome;

/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGCSDK.CMsgClientWelcome.Location
 */
class Location extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGCSDK\CMsgClientWelcome\Location) {
