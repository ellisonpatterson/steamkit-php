...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGCSDK.CMsgGCMultiplexMessage_Response
 */
class CMsgGCMultiplexMessage_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGCSDK\CMsgGCMultiplexMessage_Response) {
