...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGCSDK.CGCToGCMsgMasterAck_Response
 */
class CGCToGCMsgMasterAck_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGCSDK\CGCToGCMsgMasterAck_Response) {
