...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgGCStorePurchaseFinalize
 */
class CMsgGCStorePurchaseFinalize extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgGCStorePurchaseFinalize) {
