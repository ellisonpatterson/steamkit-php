...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgGCServerVersionUpdated
 */
class CMsgGCServerVersionUpdated extends \Protobuf\AbstractMessage
{
    ...
    /**
     * server_version optional uint32 = 1
     *
     * @var int
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->server_version !== null) {
            ...
            $writer->writeVarint($stream, $this->server_version);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->server_version = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->server_version !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->server_version);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgGCServerVersionUpdated) {
