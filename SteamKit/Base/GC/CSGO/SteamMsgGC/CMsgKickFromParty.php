...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgKickFromParty
 */
class CMsgKickFromParty extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgKickFromParty) {
