...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgGCStorePurchaseFinalizeResponse
 */
class CMsgGCStorePurchaseFinalizeResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgGCStorePurchaseFinalizeResponse) {
