...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgGCStorePurchaseCancelResponse
 */
class CMsgGCStorePurchaseCancelResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgGCStorePurchaseCancelResponse) {
