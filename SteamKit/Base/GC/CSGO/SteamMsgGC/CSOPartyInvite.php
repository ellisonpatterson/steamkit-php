...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgGC.CSOPartyInvite
 */
class CSOPartyInvite extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CSOPartyInvite) {
