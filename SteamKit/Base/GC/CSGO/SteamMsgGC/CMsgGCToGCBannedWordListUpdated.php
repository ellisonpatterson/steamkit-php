...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgGCToGCBannedWordListUpdated
 */
class CMsgGCToGCBannedWordListUpdated extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgGCToGCBannedWordListUpdated) {
