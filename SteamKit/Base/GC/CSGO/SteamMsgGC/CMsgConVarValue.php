...
/**
 * Protobuf message : SteamKit.Base.GC.CSGO.SteamMsgGC.CMsgConVarValue
 */
class CMsgConVarValue extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CSGO\SteamMsgGC\CMsgConVarValue) {
