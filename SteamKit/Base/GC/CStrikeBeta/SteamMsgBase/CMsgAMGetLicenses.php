...
/**
 * Protobuf message : SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgAMGetLicenses
 */
class CMsgAMGetLicenses extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgAMGetLicenses) {
