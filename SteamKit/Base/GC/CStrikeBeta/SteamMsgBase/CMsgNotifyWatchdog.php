...
/**
 * Protobuf message : SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgNotifyWatchdog
 */
class CMsgNotifyWatchdog extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgNotifyWatchdog) {
