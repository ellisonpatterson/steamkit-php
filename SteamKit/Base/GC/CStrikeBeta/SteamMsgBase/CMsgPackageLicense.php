...
/**
 * Protobuf message : SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgPackageLicense
 */
class CMsgPackageLicense extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgPackageLicense) {
