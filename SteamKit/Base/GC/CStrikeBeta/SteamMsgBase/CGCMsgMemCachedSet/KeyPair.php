...
namespace SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CGCMsgMemCachedSet;

/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CGCMsgMemCachedSet.KeyPair
 */
class KeyPair extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CGCMsgMemCachedSet\KeyPair) {
