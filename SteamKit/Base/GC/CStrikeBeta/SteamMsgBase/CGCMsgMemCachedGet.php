...
/**
 * Protobuf message : SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CGCMsgMemCachedGet
 */
class CGCMsgMemCachedGet extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CGCMsgMemCachedGet) {
