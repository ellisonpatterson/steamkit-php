...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgHttpRequest.QueryParam
 */
class QueryParam extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgHttpRequest\QueryParam) {
