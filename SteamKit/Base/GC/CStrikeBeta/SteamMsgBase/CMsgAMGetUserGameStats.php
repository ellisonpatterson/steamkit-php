...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgAMGetUserGameStats
 */
class CMsgAMGetUserGameStats extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgAMGetUserGameStats) {
