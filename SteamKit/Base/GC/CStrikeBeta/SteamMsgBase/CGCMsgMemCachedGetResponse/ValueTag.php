...
namespace SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CGCMsgMemCachedGetResponse;
...
class ValueTag extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CGCMsgMemCachedGetResponse\ValueTag) {
