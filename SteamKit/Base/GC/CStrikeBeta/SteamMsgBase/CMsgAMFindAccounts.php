...
/**
 * Protobuf message : SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgAMFindAccounts
 */
class CMsgAMFindAccounts extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgAMFindAccounts) {
