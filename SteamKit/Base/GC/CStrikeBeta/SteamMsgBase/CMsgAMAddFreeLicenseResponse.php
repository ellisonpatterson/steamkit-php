...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrikeBeta.SteamMsgBase.CMsgAMAddFreeLicenseResponse
 */
class CMsgAMAddFreeLicenseResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrikeBeta\SteamMsgBase\CMsgAMAddFreeLicenseResponse) {
