...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgPostURL
 */
class CMsgPostURL extends \Protobuf\AbstractMessage
{
     ...
     * @param string $value
     */
    public function setPost($value = null)
    {
        $this->post = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->post !== null) {
            ...
            $writer->writeString($stream, $this->post);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->post = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->post !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->post);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgPostURL) {
        ...
        $this->post = ($message->post !== null) ? $message->post : $this->post;
