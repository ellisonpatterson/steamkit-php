...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgKeyDown
 */
class CMsgKeyDown extends \Protobuf\AbstractMessage
{
    ...
    /**
     * Check if 'keyCode' has a value
     *
     * @return bool
     */
    public function hasKeyCode()
    {
     ...
     * @param int $value
     */
    public function setKeyCode($value = null)
    {
        $this->keyCode = $value;
    }
     ...
     * @param int $value
     */
    public function setModifiers($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setKeyCode($values['keyCode']);
        $message->setModifiers($values['modifiers']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->keyCode !== null) {
            ...
            $writer->writeVarint($stream, $this->keyCode);
        }

        if ($this->modifiers !== null) {
            $writer->writeVarint($stream, 24);
            $writer->writeVarint($stream, $this->modifiers);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->keyCode = $reader->readVarint($stream);
            ...
            if ($tag === 3) {
                ...
                $this->modifiers = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->keyCode !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->keyCode);
        }

        if ($this->modifiers !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->modifiers);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgKeyDown) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->keyCode = ($message->keyCode !== null) ? $message->keyCode : $this->keyCode;
