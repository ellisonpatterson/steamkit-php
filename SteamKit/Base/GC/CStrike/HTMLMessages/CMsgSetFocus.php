...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgSetFocus
 */
class CMsgSetFocus extends \Protobuf\AbstractMessage
{
     ...
     * @param bool $value
     */
    public function setFocus($value = null)
    {
        $this->focus = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->focus !== null) {
            ...
            $writer->writeBool($stream, $this->focus);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->focus = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgSetFocus) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->focus = ($message->focus !== null) ? $message->focus : $this->focus;
    }
