...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgBrowserRemove
 */
class CMsgBrowserRemove extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgBrowserRemove) {
