...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CHTMLHeader
 */
class CHTMLHeader extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CHTMLHeader) {
