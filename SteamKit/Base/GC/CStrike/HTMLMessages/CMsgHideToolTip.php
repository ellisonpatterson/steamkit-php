...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgHideToolTip
 */
class CMsgHideToolTip extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgHideToolTip) {
