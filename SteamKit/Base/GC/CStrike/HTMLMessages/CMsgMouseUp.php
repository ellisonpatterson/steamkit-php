...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgMouseUp
 */
class CMsgMouseUp extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgMouseUp) {
