...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgPopupHTMLWindow
 */
class CMsgPopupHTMLWindow extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgPopupHTMLWindow) {
