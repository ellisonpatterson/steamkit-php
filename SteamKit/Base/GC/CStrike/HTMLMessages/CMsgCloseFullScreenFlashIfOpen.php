...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgCloseFullScreenFlashIfOpen
 */
class CMsgCloseFullScreenFlashIfOpen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgCloseFullScreenFlashIfOpen) {
