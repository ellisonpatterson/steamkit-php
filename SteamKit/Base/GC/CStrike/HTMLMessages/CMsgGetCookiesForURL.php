...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgGetCookiesForURL
 */
class CMsgGetCookiesForURL extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgGetCookiesForURL) {
