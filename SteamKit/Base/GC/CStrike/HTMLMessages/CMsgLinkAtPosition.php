...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgLinkAtPosition
 */
class CMsgLinkAtPosition extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgLinkAtPosition) {
