...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgCopy
 */
class CMsgCopy extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgCopy) {
