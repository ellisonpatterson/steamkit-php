...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgGetZoom
 */
class CMsgGetZoom extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgGetZoom) {
