...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgMouseDblClick
 */
class CMsgMouseDblClick extends \Protobuf\AbstractMessage
{
    ...
    /**
     * mouse_button optional uint32 = 2
     *
     * @var int
     */
    protected $mouse_button = null;
    ...
    /**
     * Check if 'mouse_button' has a value
     *
     * @return bool
     */
    public function hasMouseButton()
    {
        return $this->mouse_button !== null;
    }

    /**
     * Get 'mouse_button' value
     *
     * @return int
     */
    ...
    /**
     * Set 'mouse_button' value
     *
     * @param int $value
     */
    public function setMouseButton($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setMouseButton($values['mouse_button']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->mouse_button !== null) {
            $writer->writeVarint($stream, 16);
            $writer->writeVarint($stream, $this->mouse_button);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->mouse_button = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->mouse_button !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->mouse_button);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgMouseDblClick) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->mouse_button = ($message->mouse_button !== null) ? $message->mouse_button : $this->mouse_button;
    }
