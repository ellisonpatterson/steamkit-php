...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgSearchResults
 */
class CMsgSearchResults extends \Protobuf\AbstractMessage
{
    ...
    /**
     * activeMatch optional int32 = 2
     *
     * @var int
     */
    protected $activeMatch = null;

    /**
     * results optional int32 = 3
     *
     * @var int
     */
    ...
    /**
     * Check if 'activeMatch' has a value
     *
     * @return bool
     */
     ...
     * @param int $value
     */
    public function setActiveMatch($value = null)
    {
     ...
     * @param int $value
     */
    public function setResults($value = null)
    {
        $this->results = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setActiveMatch($values['activeMatch']);
        $message->setResults($values['results']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->activeMatch !== null) {
            ...
            $writer->writeVarint($stream, $this->activeMatch);
        }

        if ($this->results !== null) {
            $writer->writeVarint($stream, 24);
            $writer->writeVarint($stream, $this->results);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->activeMatch = $reader->readVarint($stream);
            ...
            if ($tag === 3) {
                ...
                $this->results = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->activeMatch !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->activeMatch);
        }

        if ($this->results !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->results);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgSearchResults) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->activeMatch = ($message->activeMatch !== null) ? $message->activeMatch : $this->activeMatch;
