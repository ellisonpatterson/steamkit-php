...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgSizePopup
 */
class CMsgSizePopup extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgSizePopup) {
