...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgSetZoomLevel
 */
class CMsgSetZoomLevel extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->zoom !== null) {
            ...
            $writer->writeVarint($stream, $this->zoom);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->zoom = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->zoom !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->zoom);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgSetZoomLevel) {
