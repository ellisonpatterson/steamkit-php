...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgReload
 */
class CMsgReload extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgReload) {
