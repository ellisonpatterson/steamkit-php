...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgShowPopup
 */
class CMsgShowPopup extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgShowPopup) {
