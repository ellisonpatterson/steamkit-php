...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgLoadingResource
 */
class CMsgLoadingResource extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgLoadingResource) {
