...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgKeyChar
 */
class CMsgKeyChar extends \Protobuf\AbstractMessage
{
    ...
    /**
     * unichar optional uint32 = 2
     *
     * @var int
     */
    protected $unichar = null;
    ...
    /**
     * Check if 'unichar' has a value
     *
     * @return bool
     */
    public function hasUnichar()
    {
        return $this->unichar !== null;
    }
     ...
     * @param int $value
     */
    public function setUnichar($value = null)
    {
        $this->unichar = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setUnichar($values['unichar']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->unichar !== null) {
            ...
            $writer->writeVarint($stream, $this->unichar);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->unichar = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->unichar !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->unichar);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgKeyChar) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->unichar = ($message->unichar !== null) ? $message->unichar : $this->unichar;
    }
