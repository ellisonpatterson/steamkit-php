...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgOpenSteamURL
 */
class CMsgOpenSteamURL extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgOpenSteamURL) {
