...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgMouseDown
 */
class CMsgMouseDown extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgMouseDown) {
