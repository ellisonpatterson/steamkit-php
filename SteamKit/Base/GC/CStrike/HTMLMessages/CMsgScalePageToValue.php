...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgScalePageToValue
 */
class CMsgScalePageToValue extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->scale !== null) {
            ...
            $writer->writeFloat($stream, $this->scale);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->scale = $reader->readFloat($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgScalePageToValue) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->browser_handle = ($message->browser_handle !== null) ? $message->browser_handle : $this->browser_handle;
        $this->scale = ($message->scale !== null) ? $message->scale : $this->scale;
