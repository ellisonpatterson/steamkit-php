...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgStopLoad
 */
class CMsgStopLoad extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgStopLoad) {
