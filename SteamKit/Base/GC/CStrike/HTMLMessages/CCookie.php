...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CCookie
 */
class CCookie extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CCookie) {
