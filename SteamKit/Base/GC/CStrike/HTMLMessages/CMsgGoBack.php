...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgGoBack
 */
class CMsgGoBack extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgGoBack) {
