...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgSetHTMLTitle
 */
class CMsgSetHTMLTitle extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgSetHTMLTitle) {
