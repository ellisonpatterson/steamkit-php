...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgFullRepaint
 */
class CMsgFullRepaint extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgFullRepaint) {
