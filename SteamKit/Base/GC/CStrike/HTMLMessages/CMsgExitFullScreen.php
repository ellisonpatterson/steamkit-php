...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgExitFullScreen
 */
class CMsgExitFullScreen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgExitFullScreen) {
