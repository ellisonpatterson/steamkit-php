...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgStopFind
 */
class CMsgStopFind extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgStopFind) {
