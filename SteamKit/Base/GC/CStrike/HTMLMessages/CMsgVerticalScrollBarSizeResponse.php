...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgVerticalScrollBarSizeResponse
 */
class CMsgVerticalScrollBarSizeResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgVerticalScrollBarSizeResponse) {
