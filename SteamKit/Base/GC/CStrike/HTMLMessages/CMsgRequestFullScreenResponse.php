...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgRequestFullScreenResponse
 */
class CMsgRequestFullScreenResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgRequestFullScreenResponse) {
