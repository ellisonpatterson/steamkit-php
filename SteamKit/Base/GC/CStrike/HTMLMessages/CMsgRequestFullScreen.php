...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgRequestFullScreen
 */
class CMsgRequestFullScreen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgRequestFullScreen) {
