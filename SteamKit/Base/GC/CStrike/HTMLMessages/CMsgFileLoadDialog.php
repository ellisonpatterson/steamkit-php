...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgFileLoadDialog
 */
class CMsgFileLoadDialog extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgFileLoadDialog) {
