...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgGoForward
 */
class CMsgGoForward extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgGoForward) {
