...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgAddHeader
 */
class CMsgAddHeader extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgAddHeader) {
