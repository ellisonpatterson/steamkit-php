...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgShowToolTip
 */
class CMsgShowToolTip extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgShowToolTip) {
