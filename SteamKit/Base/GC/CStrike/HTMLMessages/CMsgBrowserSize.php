...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgBrowserSize
 */
class CMsgBrowserSize extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgBrowserSize) {
