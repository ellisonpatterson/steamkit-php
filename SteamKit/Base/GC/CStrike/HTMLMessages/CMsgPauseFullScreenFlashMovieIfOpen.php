...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgPauseFullScreenFlashMovieIfOpen
 */
class CMsgPauseFullScreenFlashMovieIfOpen extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgPauseFullScreenFlashMovieIfOpen) {
