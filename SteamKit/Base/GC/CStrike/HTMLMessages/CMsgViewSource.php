...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgViewSource
 */
class CMsgViewSource extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgViewSource) {
