...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgFileLoadDialogResponse
 */
class CMsgFileLoadDialogResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgFileLoadDialogResponse) {
