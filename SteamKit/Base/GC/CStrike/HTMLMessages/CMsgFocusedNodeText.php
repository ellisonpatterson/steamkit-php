...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgFocusedNodeText
 */
class CMsgFocusedNodeText extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgFocusedNodeText) {
