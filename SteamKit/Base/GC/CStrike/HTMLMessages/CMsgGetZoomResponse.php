...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgGetZoomResponse
 */
class CMsgGetZoomResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgGetZoomResponse) {
