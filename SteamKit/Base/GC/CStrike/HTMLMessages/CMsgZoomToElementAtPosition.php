...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgZoomToElementAtPosition
 */
class CMsgZoomToElementAtPosition extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgZoomToElementAtPosition) {
