...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgMouseLeave
 */
class CMsgMouseLeave extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgMouseLeave) {
