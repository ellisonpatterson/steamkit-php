...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgOpenNewTab
 */
class CMsgOpenNewTab extends \Protobuf\AbstractMessage
{
    ...
    /**
     * bForeground optional bool = 3
     *
     * @var bool
     */
    protected $bForeground = null;
    ...
    /**
     * Check if 'bForeground' has a value
     *
     * @return bool
     */
    public function hasBForeground()
    {
        return $this->bForeground !== null;
    }

    /**
     * Get 'bForeground' value
     *
     * @return bool
     */
    public function getBForeground()
    {
        return $this->bForeground;
    }

    /**
     * Set 'bForeground' value
     *
     * @param bool $value
     */
    public function setBForeground($value = null)
    {
        $this->bForeground = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setBForeground($values['bForeground']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->bForeground !== null) {
            $writer->writeVarint($stream, 24);
            $writer->writeBool($stream, $this->bForeground);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->bForeground = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgOpenNewTab) {
        ...
        $this->bForeground = ($message->bForeground !== null) ? $message->bForeground : $this->bForeground;
    }
