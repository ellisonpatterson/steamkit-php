...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgBrowserReady
 */
class CMsgBrowserReady extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgBrowserReady) {
