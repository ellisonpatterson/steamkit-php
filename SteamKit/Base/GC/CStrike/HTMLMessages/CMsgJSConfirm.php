...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgJSConfirm
 */
class CMsgJSConfirm extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgJSConfirm) {
