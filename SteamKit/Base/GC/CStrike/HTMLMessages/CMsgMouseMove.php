...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgMouseMove
 */
class CMsgMouseMove extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgMouseMove) {
