...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgJSAlert
 */
class CMsgJSAlert extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgJSAlert) {
