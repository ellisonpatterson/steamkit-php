...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgBrowserPosition
 */
class CMsgBrowserPosition extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgBrowserPosition) {
