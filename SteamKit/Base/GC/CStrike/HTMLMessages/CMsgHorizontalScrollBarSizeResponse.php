...
/**
 * Protobuf message :
 * SteamKit.Base.GC.CStrike.HTMLMessages.CMsgHorizontalScrollBarSizeResponse
 */
class CMsgHorizontalScrollBarSizeResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgHorizontalScrollBarSizeResponse) {
