...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgKeyUp
 */
class CMsgKeyUp extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgKeyUp) {
