...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgNeedsPaintResponse
 */
class CMsgNeedsPaintResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgNeedsPaintResponse) {
