...
/**
 * Protobuf message : SteamKit.Base.GC.CStrike.HTMLMessages.CMsgHidePopup
 */
class CMsgHidePopup extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\CStrike\HTMLMessages\CMsgHidePopup) {
