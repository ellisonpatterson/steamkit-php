...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCGetEmailTemplate
 */
class CMsgGCGetEmailTemplate extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCGetEmailTemplate) {
