...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CGCSystemMsg_GetAccountDetails
 */
class CGCSystemMsg_GetAccountDetails extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CGCSystemMsg_GetAccountDetails) {
