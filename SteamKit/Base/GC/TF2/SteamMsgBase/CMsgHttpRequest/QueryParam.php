...
namespace SteamKit\Base\GC\TF2\SteamMsgBase\CMsgHttpRequest;

/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgBase.CMsgHttpRequest.QueryParam
 */
class QueryParam extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgHttpRequest\QueryParam) {
