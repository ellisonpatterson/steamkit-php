...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCHAccountPhoneNumberChange
 */
class CMsgGCHAccountPhoneNumberChange extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCHAccountPhoneNumberChange) {
