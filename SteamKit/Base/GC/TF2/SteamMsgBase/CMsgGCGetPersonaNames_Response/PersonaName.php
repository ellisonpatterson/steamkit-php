...
namespace SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCGetPersonaNames_Response;
...
class PersonaName extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCGetPersonaNames_Response\PersonaName) {
