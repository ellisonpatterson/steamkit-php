...
namespace SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCHUpdateSession;

/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCHUpdateSession.ExtraField
 */
class ExtraField extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCHUpdateSession\ExtraField) {
