...
namespace SteamKit\Base\GC\TF2\SteamMsgBase\CGCMsgMemCachedSet;

/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgBase.CGCMsgMemCachedSet.KeyPair
 */
class KeyPair extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CGCMsgMemCachedSet\KeyPair) {
