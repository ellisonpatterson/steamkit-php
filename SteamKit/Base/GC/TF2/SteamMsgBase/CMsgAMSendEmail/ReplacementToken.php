...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgAMSendEmail.ReplacementToken
 */
class ReplacementToken extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgAMSendEmail\ReplacementToken) {
