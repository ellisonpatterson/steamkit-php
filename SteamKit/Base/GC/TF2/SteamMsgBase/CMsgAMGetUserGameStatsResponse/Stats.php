...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgAMGetUserGameStatsResponse.Stats
 */
class Stats extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgAMGetUserGameStatsResponse\Stats) {
