...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCGetPartnerAccountLink
 */
class CMsgGCGetPartnerAccountLink extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCGetPartnerAccountLink) {
