...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCMsgSetOptions.MessageRange
 */
class MessageRange extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->low === null) {
            throw new \UnexpectedValueException('Field "\\SteamKit\\Base\\GC\\TF2\\SteamMsgBase\\CMsgGCMsgSetOptions\\MessageRange#low" (tag 1) is required but has no value.');
        }

        if ($this->high === null) {
            throw new \UnexpectedValueException('Field "\\SteamKit\\Base\\GC\\TF2\\SteamMsgBase\\CMsgGCMsgSetOptions\\MessageRange#high" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCMsgSetOptions\MessageRange) {
