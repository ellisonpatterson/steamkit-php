...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgBase.CMsgAMSendEmailResponse
 */
class CMsgAMSendEmailResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgAMSendEmailResponse) {
