...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgBase.CMsgGCMsgMasterSetClientMsgRouting_Response
 */
class CMsgGCMsgMasterSetClientMsgRouting_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgBase\CMsgGCMsgMasterSetClientMsgRouting_Response) {
