...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgGCSDK.CMsgGCMultiplexMessage
 */
class CMsgGCMultiplexMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCSDK\CMsgGCMultiplexMessage) {
