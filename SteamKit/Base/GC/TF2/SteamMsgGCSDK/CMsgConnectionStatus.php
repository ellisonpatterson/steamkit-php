...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgGCSDK.CMsgConnectionStatus
 */
class CMsgConnectionStatus extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->status = \SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus::GCConnectionStatus_HAVE_SESSION();
     ...
     * Set 'status' value
     *
     * @param \SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus $value
     */
    public function setStatus(\SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus $value = null)
    {
        $this->status = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        $message = new self();
        $values  = array_merge([
            'status' => \SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus::GCConnectionStatus_HAVE_SESSION(),
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.SteamKit.Base.GC.TF2.SteamMsgGCSDK.GCConnectionStatus',
                    'default_value' => \SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus::GCConnectionStatus_HAVE_SESSION()
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->status = \SteamKit\Base\GC\TF2\SteamMsgGCSDK\GCConnectionStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCSDK\CMsgConnectionStatus) {
