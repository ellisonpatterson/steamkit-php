...
namespace SteamKit\Base\GC\TF2\SteamMsgGCSDK\CGCToGCMsgMasterStartupComplete;

/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCSDK.CGCToGCMsgMasterStartupComplete.GCInfo
 */
class GCInfo extends \Protobuf\AbstractMessage
{
    ...
    /**
     * machine_name optional string = 2
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCSDK\CGCToGCMsgMasterStartupComplete\GCInfo) {
