...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCSDK.CMsgGCRequestSubGCSessionInfo
 */
class CMsgGCRequestSubGCSessionInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCSDK\CMsgGCRequestSubGCSessionInfo) {
