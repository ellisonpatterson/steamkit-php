...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCSDK.CMsgGCToGCIncrementRecruitmentLevel
 */
class CMsgGCToGCIncrementRecruitmentLevel extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'CMsgGCToGCIncrementRecruitmentLevel',
            'field'     => [
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCSDK\CMsgGCToGCIncrementRecruitmentLevel) {
