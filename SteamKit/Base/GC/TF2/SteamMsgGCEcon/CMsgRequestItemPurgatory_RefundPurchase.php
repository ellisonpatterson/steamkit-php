...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgRequestItemPurgatory_RefundPurchase
 */
class CMsgRequestItemPurgatory_RefundPurchase extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgRequestItemPurgatory_RefundPurchase) {
