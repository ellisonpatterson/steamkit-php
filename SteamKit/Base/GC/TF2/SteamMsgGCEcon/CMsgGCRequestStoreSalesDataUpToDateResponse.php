...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgGCRequestStoreSalesDataUpToDateResponse
 */
class CMsgGCRequestStoreSalesDataUpToDateResponse extends \Protobuf\AbstractMessage
{
    ...
    /**
     * expiration_time optional uint32 = 2
     *
     * @var int
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgGCRequestStoreSalesDataUpToDateResponse) {
