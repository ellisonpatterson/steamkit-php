...
/**
 * Protobuf message : SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgCraftingResponse
 */
class CMsgCraftingResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgCraftingResponse) {
