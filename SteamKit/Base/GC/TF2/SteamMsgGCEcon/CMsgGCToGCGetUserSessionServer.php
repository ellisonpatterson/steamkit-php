...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgGCToGCGetUserSessionServer
 */
class CMsgGCToGCGetUserSessionServer extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgGCToGCGetUserSessionServer) {
