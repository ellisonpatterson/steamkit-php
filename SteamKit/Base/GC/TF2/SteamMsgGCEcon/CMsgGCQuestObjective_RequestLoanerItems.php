...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgGCQuestObjective_RequestLoanerItems
 */
class CMsgGCQuestObjective_RequestLoanerItems extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'CMsgGCQuestObjective_RequestLoanerItems',
            'field'     => [
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgGCQuestObjective_RequestLoanerItems) {
