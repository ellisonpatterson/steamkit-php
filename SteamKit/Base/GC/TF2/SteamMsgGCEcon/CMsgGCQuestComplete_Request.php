...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgGCQuestComplete_Request
 */
class CMsgGCQuestComplete_Request extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'CMsgGCQuestComplete_Request',
            'field'     => [
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgGCQuestComplete_Request) {
