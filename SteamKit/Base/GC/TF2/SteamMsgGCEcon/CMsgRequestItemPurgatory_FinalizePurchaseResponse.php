...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgRequestItemPurgatory_FinalizePurchaseResponse
 */
class CMsgRequestItemPurgatory_FinalizePurchaseResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgRequestItemPurgatory_FinalizePurchaseResponse) {
