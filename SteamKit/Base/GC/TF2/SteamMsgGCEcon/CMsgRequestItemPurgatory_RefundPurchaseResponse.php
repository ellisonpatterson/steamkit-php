...
/**
 * Protobuf message :
 * SteamKit.Base.GC.TF2.SteamMsgGCEcon.CMsgRequestItemPurgatory_RefundPurchaseResponse
 */
class CMsgRequestItemPurgatory_RefundPurchaseResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\GC\TF2\SteamMsgGCEcon\CMsgRequestItemPurgatory_RefundPurchaseResponse) {
