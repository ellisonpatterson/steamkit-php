...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientMMSCreateLobbyResponse
 */
class CMsgClientMMSCreateLobbyResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSCreateLobbyResponse) {
