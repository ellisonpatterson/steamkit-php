...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientAMGetPersonaNameHistory;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientAMGetPersonaNameHistory.IdInstance
 */
class IdInstance extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientAMGetPersonaNameHistory\IdInstance) {
