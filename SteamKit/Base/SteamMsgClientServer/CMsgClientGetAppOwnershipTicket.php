...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientGetAppOwnershipTicket
 */
class CMsgClientGetAppOwnershipTicket extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientGetAppOwnershipTicket) {
