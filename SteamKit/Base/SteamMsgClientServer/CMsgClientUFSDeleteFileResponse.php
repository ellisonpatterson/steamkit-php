...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientUFSDeleteFileResponse
 */
class CMsgClientUFSDeleteFileResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUFSDeleteFileResponse) {
