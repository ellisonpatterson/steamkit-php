...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientSetPlayerNicknameResponse
 */
class CMsgClientSetPlayerNicknameResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientSetPlayerNicknameResponse) {
