...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientUDSInviteToGame
 */
class CMsgClientUDSInviteToGame extends \Protobuf\AbstractMessage
{
    ...
    /**
     * connect_string optional string = 3
     *
     * @var string
     */
    protected $connect_string = null;
    ...
    /**
     * Check if 'connect_string' has a value
     *
     * @return bool
     */
    public function hasConnectString()
    {
        return $this->connect_string !== null;
    }

    /**
     * Get 'connect_string' value
     *
     * @return string
     */
    ...
    /**
     * Set 'connect_string' value
     *
     * @param string $value
     */
    public function setConnectString($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setConnectString($values['connect_string']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->connect_string !== null) {
            ...
            $writer->writeString($stream, $this->connect_string);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->connect_string = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->connect_string !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->connect_string);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUDSInviteToGame) {
        ...
        $this->connect_string = ($message->connect_string !== null) ? $message->connect_string : $this->connect_string;
    }
