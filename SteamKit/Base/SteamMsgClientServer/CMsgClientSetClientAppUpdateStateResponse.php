...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientSetClientAppUpdateStateResponse
 */
class CMsgClientSetClientAppUpdateStateResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientSetClientAppUpdateStateResponse) {
