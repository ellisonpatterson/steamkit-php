...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientPICSAccessTokenResponse;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientPICSAccessTokenResponse.PackageToken
 */
class PackageToken extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientPICSAccessTokenResponse\PackageToken) {
