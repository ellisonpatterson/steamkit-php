...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientSetClientAppUpdateState
 */
class CMsgClientSetClientAppUpdateState extends \Protobuf\AbstractMessage
{
     ...
     * @param bool $value
     */
    public function setUpdate($value = null)
    {
        $this->update = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setUpdate($values['update']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->update !== null) {
            ...
            $writer->writeBool($stream, $this->update);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->update = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientSetClientAppUpdateState) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->appid = ($message->appid !== null) ? $message->appid : $this->appid;
        $this->update = ($message->update !== null) ? $message->update : $this->update;
    }
