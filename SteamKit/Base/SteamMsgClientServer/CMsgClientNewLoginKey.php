...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientNewLoginKey
 */
class CMsgClientNewLoginKey extends \Protobuf\AbstractMessage
{
     ...
     * @param int $value
     */
    public function setUniqueId($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setUniqueId($values['unique_id']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->unique_id !== null) {
            ...
            $writer->writeVarint($stream, $this->unique_id);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->unique_id = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->unique_id !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->unique_id);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientNewLoginKey) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->unique_id = ($message->unique_id !== null) ? $message->unique_id : $this->unique_id;
