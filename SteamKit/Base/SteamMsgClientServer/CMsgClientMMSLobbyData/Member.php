...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientMMSLobbyData;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientMMSLobbyData.Member
 */
class Member extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSLobbyData\Member) {
