...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientStoreUserStats;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientStoreUserStats.Stats_To_Store
 */
class Stats_To_Store extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientStoreUserStats\Stats_To_Store) {
