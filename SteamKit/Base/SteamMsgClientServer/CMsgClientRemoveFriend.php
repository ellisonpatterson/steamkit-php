...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientRemoveFriend
 */
class CMsgClientRemoveFriend extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientRemoveFriend) {
