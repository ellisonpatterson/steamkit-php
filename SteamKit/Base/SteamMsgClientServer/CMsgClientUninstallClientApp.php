...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientUninstallClientApp
 */
class CMsgClientUninstallClientApp extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUninstallClientApp) {
