...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientLBSSetUGCResponse
 */
class CMsgClientLBSSetUGCResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientLBSSetUGCResponse) {
