...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientGetClientAppListResponse\App;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientGetClientAppListResponse.App.DLC
 */
class DLC extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientGetClientAppListResponse\App\DLC) {
