...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientPlayerNicknameList;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientPlayerNicknameList.PlayerNickname
 */
class PlayerNickname extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientPlayerNicknameList\PlayerNickname) {
