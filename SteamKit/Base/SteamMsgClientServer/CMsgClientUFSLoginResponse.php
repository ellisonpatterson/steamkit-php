...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientUFSLoginResponse
 */
class CMsgClientUFSLoginResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUFSLoginResponse) {
