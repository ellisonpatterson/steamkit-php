...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientGetUserStatsResponse.Stats
 */
class Stats extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientGetUserStatsResponse\Stats) {
