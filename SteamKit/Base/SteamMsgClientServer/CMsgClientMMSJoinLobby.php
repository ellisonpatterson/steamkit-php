...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientMMSJoinLobby
 */
class CMsgClientMMSJoinLobby extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSJoinLobby) {
