...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientMMSUserLeftLobby
 */
class CMsgClientMMSUserLeftLobby extends \Protobuf\AbstractMessage
{
    ...
    /**
     * steam_id_user optional fixed64 = 3
     *
     * @var int
     */
    ...
    /**
     * persona_name optional string = 4
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSUserLeftLobby) {
