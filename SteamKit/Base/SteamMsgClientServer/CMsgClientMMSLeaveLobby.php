...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientMMSLeaveLobby
 */
class CMsgClientMMSLeaveLobby extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSLeaveLobby) {
