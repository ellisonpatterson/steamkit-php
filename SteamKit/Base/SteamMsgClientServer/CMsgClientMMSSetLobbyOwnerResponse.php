...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientMMSSetLobbyOwnerResponse
 */
class CMsgClientMMSSetLobbyOwnerResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSSetLobbyOwnerResponse) {
