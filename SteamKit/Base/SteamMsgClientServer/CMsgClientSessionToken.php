...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientSessionToken
 */
class CMsgClientSessionToken extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientSessionToken) {
