...
namespace SteamKit\Base\SteamMsgClientServer\CMsgGSPlayerList;

/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgGSPlayerList.Player
 */
class Player extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->steam_id !== null) {
            ...
            $writer->writeVarint($stream, $this->steam_id);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->steam_id = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->steam_id !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->steam_id);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgGSPlayerList\Player) {
