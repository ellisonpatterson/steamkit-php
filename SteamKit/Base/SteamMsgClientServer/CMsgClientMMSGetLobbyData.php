...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientMMSGetLobbyData
 */
class CMsgClientMMSGetLobbyData extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSGetLobbyData) {
