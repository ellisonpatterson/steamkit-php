...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientLoggedOff
 */
class CMsgClientLoggedOff extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientLoggedOff) {
