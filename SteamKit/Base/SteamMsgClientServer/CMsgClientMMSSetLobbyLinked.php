...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientMMSSetLobbyLinked
 */
class CMsgClientMMSSetLobbyLinked extends \Protobuf\AbstractMessage
{
    ...
    /**
     * steam_id_lobby2 optional fixed64 = 3
     *
     * @var int
     */
    protected $steam_id_lobby2 = null;
    ...
    /**
     * Check if 'steam_id_lobby2' has a value
     *
     * @return bool
     */
    public function hasSteamIdLobby2()
    {
        return $this->steam_id_lobby2 !== null;
    }

    /**
     * Get 'steam_id_lobby2' value
     *
     * @return int
     */
    public function getSteamIdLobby2()
    {
        return $this->steam_id_lobby2;
    }

    /**
     * Set 'steam_id_lobby2' value
     *
     * @param int $value
     */
    public function setSteamIdLobby2($value = null)
    {
        $this->steam_id_lobby2 = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->steam_id_lobby2 !== null) {
            $writer->writeVarint($stream, 25);
            $writer->writeFixed64($stream, $this->steam_id_lobby2);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->steam_id_lobby2 = $reader->readFixed64($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSSetLobbyLinked) {
        ...
        $this->steam_id_lobby2 = ($message->steam_id_lobby2 !== null) ? $message->steam_id_lobby2 : $this->steam_id_lobby2;
    }
