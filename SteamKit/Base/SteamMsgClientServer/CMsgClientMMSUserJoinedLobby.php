...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientMMSUserJoinedLobby
 */
class CMsgClientMMSUserJoinedLobby extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientMMSUserJoinedLobby) {
