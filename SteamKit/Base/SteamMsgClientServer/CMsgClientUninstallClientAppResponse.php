...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientUninstallClientAppResponse
 */
class CMsgClientUninstallClientAppResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUninstallClientAppResponse) {
