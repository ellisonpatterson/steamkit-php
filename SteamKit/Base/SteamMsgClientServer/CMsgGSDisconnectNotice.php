...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgGSDisconnectNotice
 */
class CMsgGSDisconnectNotice extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgGSDisconnectNotice) {
