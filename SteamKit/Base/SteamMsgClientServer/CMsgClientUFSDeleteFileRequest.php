...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientUFSDeleteFileRequest
 */
class CMsgClientUFSDeleteFileRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUFSDeleteFileRequest) {
