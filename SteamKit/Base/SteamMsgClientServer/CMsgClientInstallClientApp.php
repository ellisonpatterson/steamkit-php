...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer.CMsgClientInstallClientApp
 */
class CMsgClientInstallClientApp extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientInstallClientApp) {
