...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientUFSUploadCommitResponse;
...
class File extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientUFSUploadCommitResponse\File) {
