...
namespace SteamKit\Base\SteamMsgClientServer\CMsgClientStatsUpdated;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer.CMsgClientStatsUpdated.Updated_Stats
 */
class Updated_Stats extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer\CMsgClientStatsUpdated\Updated_Stats) {
