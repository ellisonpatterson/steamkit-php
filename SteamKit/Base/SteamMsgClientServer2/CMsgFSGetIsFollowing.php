...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgFSGetIsFollowing
 */
class CMsgFSGetIsFollowing extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgFSGetIsFollowing) {
