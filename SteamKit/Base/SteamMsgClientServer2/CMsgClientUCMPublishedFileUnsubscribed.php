...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMPublishedFileUnsubscribed
 */
class CMsgClientUCMPublishedFileUnsubscribed extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMPublishedFileUnsubscribed) {
