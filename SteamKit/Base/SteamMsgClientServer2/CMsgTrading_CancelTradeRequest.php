...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgTrading_CancelTradeRequest
 */
class CMsgTrading_CancelTradeRequest extends \Protobuf\AbstractMessage
{
    ...
    /**
     * other_steamid optional uint64 = 1
     *
     * @var int
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgTrading_CancelTradeRequest) {
