...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgAMUnlockStreamingResponse
 */
class CMsgAMUnlockStreamingResponse extends \Protobuf\AbstractMessage
{
    ...
    /**
     * encryption_key optional bytes = 2
     *
     * @var \Protobuf\Stream
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgAMUnlockStreamingResponse) {
