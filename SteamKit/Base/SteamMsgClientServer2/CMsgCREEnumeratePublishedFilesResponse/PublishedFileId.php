...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgCREEnumeratePublishedFilesResponse;
...
class PublishedFileId extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgCREEnumeratePublishedFilesResponse\PublishedFileId) {
