...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientFSGetFriendMessageHistory
 */
class CMsgClientFSGetFriendMessageHistory extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientFSGetFriendMessageHistory) {
