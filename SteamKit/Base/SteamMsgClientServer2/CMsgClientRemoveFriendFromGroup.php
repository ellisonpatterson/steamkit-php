...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientRemoveFriendFromGroup
 */
class CMsgClientRemoveFriendFromGroup extends \Protobuf\AbstractMessage
{
    ...
    /**
     * steamiduser optional fixed64 = 2
     *
     * @var int
     */
    protected $steamiduser = null;
    ...
    /**
     * Check if 'steamiduser' has a value
     *
     * @return bool
     */
    public function hasSteamiduser()
    {
        return $this->steamiduser !== null;
    }

    /**
     * Get 'steamiduser' value
     *
     * @return int
     */
    ...
    /**
     * Set 'steamiduser' value
     *
     * @param int $value
     */
    public function setSteamiduser($value = null)
    {
        $this->steamiduser = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setSteamiduser($values['steamiduser']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->steamiduser !== null) {
            ...
            $writer->writeFixed64($stream, $this->steamiduser);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->steamiduser = $reader->readFixed64($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientRemoveFriendFromGroup) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->groupid = ($message->groupid !== null) ? $message->groupid : $this->groupid;
        $this->steamiduser = ($message->steamiduser !== null) ? $message->steamiduser : $this->steamiduser;
    }
