...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMSetUserPublishedFileActionResponse
 */
class CMsgClientUCMSetUserPublishedFileActionResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMSetUserPublishedFileActionResponse) {
