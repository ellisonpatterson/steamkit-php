...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMEnumeratePublishedFilesByUserAction
 */
class CMsgClientUCMEnumeratePublishedFilesByUserAction extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMEnumeratePublishedFilesByUserAction) {
