...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgCREGetUserPublishedItemVoteDetails;
...
class PublishedFileId extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgCREGetUserPublishedItemVoteDetails\PublishedFileId) {
