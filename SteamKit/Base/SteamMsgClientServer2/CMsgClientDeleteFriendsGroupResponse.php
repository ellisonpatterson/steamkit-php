...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientDeleteFriendsGroupResponse
 */
class CMsgClientDeleteFriendsGroupResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientDeleteFriendsGroupResponse) {
