...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgClientWorkshopItemChangesResponse;
...
class WorkshopItemInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientWorkshopItemChangesResponse\WorkshopItemInfo) {
