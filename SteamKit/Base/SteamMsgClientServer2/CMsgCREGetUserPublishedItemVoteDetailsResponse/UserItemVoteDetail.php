...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgCREGetUserPublishedItemVoteDetailsResponse;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgCREGetUserPublishedItemVoteDetailsResponse.UserItemVoteDetail
 */
class UserItemVoteDetail extends \Protobuf\AbstractMessage
{
     ...
     * @param int $value
     */
    public function setVote($value = null)
    {
        $this->vote = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->vote !== null) {
            ...
            $writer->writeVarint($stream, $this->vote);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->vote = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->vote !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->vote);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgCREGetUserPublishedItemVoteDetailsResponse\UserItemVoteDetail) {
        ...
        $this->vote = ($message->vote !== null) ? $message->vote : $this->vote;
    }
