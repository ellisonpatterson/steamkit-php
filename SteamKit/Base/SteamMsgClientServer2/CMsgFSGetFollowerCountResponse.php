...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgFSGetFollowerCountResponse
 */
class CMsgFSGetFollowerCountResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgFSGetFollowerCountResponse) {
