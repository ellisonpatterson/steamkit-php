...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgClientWorkshopItemInfoRequest;
...
class WorkshopItem extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientWorkshopItemInfoRequest\WorkshopItem) {
