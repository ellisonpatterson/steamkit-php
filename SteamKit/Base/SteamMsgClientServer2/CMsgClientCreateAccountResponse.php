...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientCreateAccountResponse
 */
class CMsgClientCreateAccountResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientCreateAccountResponse) {
