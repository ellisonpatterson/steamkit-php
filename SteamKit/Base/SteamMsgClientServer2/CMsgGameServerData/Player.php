...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgGameServerData;

/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgGameServerData.Player
 */
class Player extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgGameServerData\Player) {
