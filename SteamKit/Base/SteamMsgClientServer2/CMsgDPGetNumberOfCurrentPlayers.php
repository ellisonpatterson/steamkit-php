...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgDPGetNumberOfCurrentPlayers
 */
class CMsgDPGetNumberOfCurrentPlayers extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgDPGetNumberOfCurrentPlayers) {
