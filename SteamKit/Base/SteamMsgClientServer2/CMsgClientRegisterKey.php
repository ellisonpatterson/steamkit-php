...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgClientRegisterKey
 */
class CMsgClientRegisterKey extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientRegisterKey) {
