...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgTrading_StartSession
 */
class CMsgTrading_StartSession extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgTrading_StartSession) {
