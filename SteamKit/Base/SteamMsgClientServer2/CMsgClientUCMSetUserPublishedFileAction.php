...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMSetUserPublishedFileAction
 */
class CMsgClientUCMSetUserPublishedFileAction extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMSetUserPublishedFileAction) {
