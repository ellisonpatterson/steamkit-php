...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientAuthorizeLocalDeviceNotification
 */
class CMsgClientAuthorizeLocalDeviceNotification extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientAuthorizeLocalDeviceNotification) {
