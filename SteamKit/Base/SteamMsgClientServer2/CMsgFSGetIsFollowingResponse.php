...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgFSGetIsFollowingResponse
 */
class CMsgFSGetIsFollowingResponse extends \Protobuf\AbstractMessage
{
    ...
    /**
     * is_following optional bool = 2
     *
     * @var bool
     */
    protected $is_following = null;
    ...
    /**
     * Check if 'is_following' has a value
     *
     * @return bool
     */
    ...
    /**
     * Set 'is_following' value
     *
     * @param bool $value
     */
    public function setIsFollowing($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setIsFollowing($values['is_following']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->is_following !== null) {
            ...
            $writer->writeBool($stream, $this->is_following);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->is_following = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgFSGetIsFollowingResponse) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->eresult = ($message->eresult !== null) ? $message->eresult : $this->eresult;
        $this->is_following = ($message->is_following !== null) ? $message->is_following : $this->is_following;
    }
