...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgClientEmoticonList;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientEmoticonList.Emoticon
 */
class Emoticon extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientEmoticonList\Emoticon) {
