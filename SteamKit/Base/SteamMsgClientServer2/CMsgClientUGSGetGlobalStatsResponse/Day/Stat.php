...
namespace SteamKit\Base\SteamMsgClientServer2\CMsgClientUGSGetGlobalStatsResponse\Day;

/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUGSGetGlobalStatsResponse.Day.Stat
 */
class Stat extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUGSGetGlobalStatsResponse\Day\Stat) {
