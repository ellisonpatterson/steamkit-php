...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMDeleteScreenshot
 */
class CMsgClientUCMDeleteScreenshot extends \Protobuf\AbstractMessage
{
    ...
    /**
     * screenshotid optional fixed64 = 1
     *
     * @var int
     */
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMDeleteScreenshot) {
