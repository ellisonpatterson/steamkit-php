...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgCREUpdateUserPublishedItemVoteResponse
 */
class CMsgCREUpdateUserPublishedItemVoteResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgCREUpdateUserPublishedItemVoteResponse) {
