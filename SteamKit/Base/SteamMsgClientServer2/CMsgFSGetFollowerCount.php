...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgFSGetFollowerCount
 */
class CMsgFSGetFollowerCount extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgFSGetFollowerCount) {
