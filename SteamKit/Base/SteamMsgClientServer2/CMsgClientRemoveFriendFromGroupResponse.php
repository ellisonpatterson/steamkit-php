...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientRemoveFriendFromGroupResponse
 */
class CMsgClientRemoveFriendFromGroupResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientRemoveFriendFromGroupResponse) {
