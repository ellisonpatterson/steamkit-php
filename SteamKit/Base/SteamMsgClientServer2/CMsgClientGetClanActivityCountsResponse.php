...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientGetClanActivityCountsResponse
 */
class CMsgClientGetClanActivityCountsResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientGetClanActivityCountsResponse) {
