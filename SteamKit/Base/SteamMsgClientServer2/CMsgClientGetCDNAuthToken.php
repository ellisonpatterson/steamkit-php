...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgClientGetCDNAuthToken
 */
class CMsgClientGetCDNAuthToken extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setHostName($values['host_name']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->host_name !== null) {
            ...
            $writer->writeString($stream, $this->host_name);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->host_name = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->host_name !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->host_name);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientGetCDNAuthToken) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->depot_id = ($message->depot_id !== null) ? $message->depot_id : $this->depot_id;
        $this->host_name = ($message->host_name !== null) ? $message->host_name : $this->host_name;
