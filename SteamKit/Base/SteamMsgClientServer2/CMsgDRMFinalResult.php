...
/**
 * Protobuf message : SteamKit.Base.SteamMsgClientServer2.CMsgDRMFinalResult
 */
class CMsgDRMFinalResult extends \Protobuf\AbstractMessage
{
    ...
    /**
     * error_detail optional uint32 = 4
     *
     * @var int
     */
    ...
    /**
     * download_file_dfs_ip optional uint32 = 6
     *
     * @var int
     */
    ...
    /**
     * download_file_dfs_port optional uint32 = 7
     *
     * @var int
     */
    ...
    /**
     * download_file_url optional string = 8
     *
     * @var string
     */
    ...
    /**
     * Check if 'error_detail' has a value
     *
     * @return bool
     */
    public function hasErrorDetail()
    {
        return $this->error_detail !== null;
    }

    /**
     * Get 'error_detail' value
     *
     * @return int
     */
    ...
    /**
     * Set 'error_detail' value
     *
     * @param int $value
     */
    public function setErrorDetail($value = null)
    {
        $this->error_detail = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setErrorDetail($values['error_detail']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->error_detail !== null) {
            ...
            $writer->writeVarint($stream, $this->error_detail);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $this->error_detail = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->error_detail !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->error_detail);
        }
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgDRMFinalResult) {
        ...
        $this->error_detail = ($message->error_detail !== null) ? $message->error_detail : $this->error_detail;
