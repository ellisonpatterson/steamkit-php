...
/**
 * Protobuf message :
 * SteamKit.Base.SteamMsgClientServer2.CMsgClientUCMEnumerateUserPublishedFiles
 */
class CMsgClientUCMEnumerateUserPublishedFiles extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\SteamMsgClientServer2\CMsgClientUCMEnumerateUserPublishedFiles) {
