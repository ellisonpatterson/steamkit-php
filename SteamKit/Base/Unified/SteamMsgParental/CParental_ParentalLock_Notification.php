 ...
 */
class CParental_ParentalLock_Notification extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgParental\CParental_ParentalLock_Notification) {
