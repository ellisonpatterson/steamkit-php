 ...
 */
class CParental_GetParentalSettings_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgParental\CParental_GetParentalSettings_Response) {
