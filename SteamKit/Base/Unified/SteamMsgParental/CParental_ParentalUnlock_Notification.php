 ...
 */
class CParental_ParentalUnlock_Notification extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgParental\CParental_ParentalUnlock_Notification) {
