...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgParental.CParental_LockClient_Request
 */
class CParental_LockClient_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgParental\CParental_LockClient_Request) {
