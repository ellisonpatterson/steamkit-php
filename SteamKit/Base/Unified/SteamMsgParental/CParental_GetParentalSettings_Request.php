 ...
 */
class CParental_GetParentalSettings_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgParental\CParental_GetParentalSettings_Request) {
