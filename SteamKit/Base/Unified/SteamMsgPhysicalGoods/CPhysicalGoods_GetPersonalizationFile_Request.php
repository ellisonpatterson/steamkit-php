 ...
 */
class CPhysicalGoods_GetPersonalizationFile_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPhysicalGoods\CPhysicalGoods_GetPersonalizationFile_Request) {
