 ...
 */
class CPhysicalGoods_GetPersonalizationFile_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPhysicalGoods\CPhysicalGoods_GetPersonalizationFile_Response) {
