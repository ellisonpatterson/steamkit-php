 ...
 */
class CDeviceAuth_AuthorizeRemoteDevice_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgDeviceAuth\CDeviceAuth_AuthorizeRemoteDevice_Request) {
