 ...
 */
class CDeviceAuth_RemoveAuthorizedBorrowers_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgDeviceAuth\CDeviceAuth_RemoveAuthorizedBorrowers_Response) {
