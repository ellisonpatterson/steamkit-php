 ...
 */
class CDeviceAuth_GetExcludedGamesInLibrary_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgDeviceAuth\CDeviceAuth_GetExcludedGamesInLibrary_Request) {
