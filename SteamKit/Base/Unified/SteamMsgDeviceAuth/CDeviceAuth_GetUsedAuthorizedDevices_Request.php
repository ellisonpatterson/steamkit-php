 ...
 */
class CDeviceAuth_GetUsedAuthorizedDevices_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgDeviceAuth\CDeviceAuth_GetUsedAuthorizedDevices_Request) {
