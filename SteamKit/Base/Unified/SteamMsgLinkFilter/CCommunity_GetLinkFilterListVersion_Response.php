 ...
 */
class CCommunity_GetLinkFilterListVersion_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgLinkFilter\CCommunity_GetLinkFilterListVersion_Response) {
