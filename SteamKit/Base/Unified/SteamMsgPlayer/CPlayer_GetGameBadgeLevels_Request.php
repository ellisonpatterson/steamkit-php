...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgPlayer.CPlayer_GetGameBadgeLevels_Request
 */
class CPlayer_GetGameBadgeLevels_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPlayer\CPlayer_GetGameBadgeLevels_Request) {
