 ...
 */
class CGameNotifications_Variable extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgGameNotifications\CGameNotifications_Variable) {
