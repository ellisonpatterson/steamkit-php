 ...
 */
class CTwoFactor_ValidateToken_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgTwoFactor\CTwoFactor_ValidateToken_Response) {
