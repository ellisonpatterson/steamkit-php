 ...
 */
class CTwoFactor_DestroyEmergencyCodes_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgTwoFactor\CTwoFactor_DestroyEmergencyCodes_Request) {
