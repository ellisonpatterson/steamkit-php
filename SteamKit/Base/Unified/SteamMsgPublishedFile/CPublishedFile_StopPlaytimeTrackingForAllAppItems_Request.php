 ...
 */
class CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request) {
