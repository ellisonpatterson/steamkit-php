...
namespace SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_QueryFiles_Request;

/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgPublishedFile.CPublishedFile_QueryFiles_Request.KVTag
 */
class KVTag extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_QueryFiles_Request\KVTag) {
