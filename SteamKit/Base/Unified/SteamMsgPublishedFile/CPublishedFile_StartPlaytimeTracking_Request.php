 ...
 */
class CPublishedFile_StartPlaytimeTracking_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_StartPlaytimeTracking_Request) {
