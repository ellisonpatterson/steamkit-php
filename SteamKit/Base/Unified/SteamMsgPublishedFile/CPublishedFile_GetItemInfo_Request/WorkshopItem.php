...
namespace SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetItemInfo_Request;

/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgPublishedFile.CPublishedFile_GetItemInfo_Request.WorkshopItem
 */
class WorkshopItem extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetItemInfo_Request\WorkshopItem) {
