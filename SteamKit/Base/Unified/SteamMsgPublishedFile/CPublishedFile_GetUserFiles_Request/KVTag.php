...
namespace SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetUserFiles_Request;
...
class KVTag extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetUserFiles_Request\KVTag) {
