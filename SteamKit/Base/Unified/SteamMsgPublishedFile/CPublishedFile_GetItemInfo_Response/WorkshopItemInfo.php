...
namespace SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetItemInfo_Response;
...
class WorkshopItemInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgPublishedFile\CPublishedFile_GetItemInfo_Response\WorkshopItemInfo) {
