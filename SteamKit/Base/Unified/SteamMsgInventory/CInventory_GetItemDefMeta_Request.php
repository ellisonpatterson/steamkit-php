 ...
 */
class CInventory_GetItemDefMeta_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgInventory\CInventory_GetItemDefMeta_Request) {
