 ...
 */
class CBroadcast_InviteToBroadcast_Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgBroadcast\CBroadcast_InviteToBroadcast_Response) {
