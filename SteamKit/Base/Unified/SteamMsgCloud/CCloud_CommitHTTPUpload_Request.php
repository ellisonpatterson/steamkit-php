...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgCloud.CCloud_CommitHTTPUpload_Request
 */
class CCloud_CommitHTTPUpload_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_CommitHTTPUpload_Request) {
