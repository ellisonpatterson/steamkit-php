...
namespace SteamKit\Base\Unified\SteamMsgCloud\CCloud_BeginHTTPUpload_Response;
...
class HTTPHeaders extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_BeginHTTPUpload_Response\HTTPHeaders) {
