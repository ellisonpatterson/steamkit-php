...
/**
 * Protobuf message : SteamKit.Base.Unified.SteamMsgCloud.CCloud_Delete_Request
 */
class CCloud_Delete_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_Delete_Request) {
