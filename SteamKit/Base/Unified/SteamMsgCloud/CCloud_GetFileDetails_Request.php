...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgCloud.CCloud_GetFileDetails_Request
 */
class CCloud_GetFileDetails_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_GetFileDetails_Request) {
