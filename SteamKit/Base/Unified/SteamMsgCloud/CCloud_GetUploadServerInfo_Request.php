...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgCloud.CCloud_GetUploadServerInfo_Request
 */
class CCloud_GetUploadServerInfo_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_GetUploadServerInfo_Request) {
