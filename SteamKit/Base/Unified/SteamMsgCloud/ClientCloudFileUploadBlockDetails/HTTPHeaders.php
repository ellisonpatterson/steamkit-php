...
namespace SteamKit\Base\Unified\SteamMsgCloud\ClientCloudFileUploadBlockDetails;
...
class HTTPHeaders extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\ClientCloudFileUploadBlockDetails\HTTPHeaders) {
