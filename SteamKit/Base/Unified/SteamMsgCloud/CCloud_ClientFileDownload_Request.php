...
/**
 * Protobuf message :
 * SteamKit.Base.Unified.SteamMsgCloud.CCloud_ClientFileDownload_Request
 */
class CCloud_ClientFileDownload_Request extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\Unified\SteamMsgCloud\CCloud_ClientFileDownload_Request) {
