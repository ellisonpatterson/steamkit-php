...
/**
 * Protobuf message : SteamKit.Base.ContentManifest.ContentManifestSignature
 */
class ContentManifestSignature extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\ContentManifest\ContentManifestSignature) {
