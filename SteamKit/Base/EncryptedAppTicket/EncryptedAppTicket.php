...
namespace SteamKit\Base\EncryptedAppTicket;

/**
 * Protobuf message : SteamKit.Base.EncryptedAppTicket.EncryptedAppTicket
 */
class EncryptedAppTicket extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \SteamKit\Base\EncryptedAppTicket\EncryptedAppTicket) {
